...
New-SBFarm `
    -SBFarmDBConnectionString 'Data Source=WingtipServer;Initial Catalog=WF_ServiceBus_ManagementDB;Integrated Security=True;Encrypt=False' `
    -InternalPortRangeStart 9000 `
    -TcpPort 9354 `
    -MessageBrokerPort 9356 `
    -RunAsAccount 'WINGTIP\SP_Workflow' `
    -AdminGroup 'BUILTIN\Administrators' `
    -GatewayDBConnectionString 'Data Source=WingtipServer;Initial Catalog=WF_ServiceBus_GatewayDatabase;Integrated Security=True;Encrypt=False' `
    -CertificateAutoGenerationKey $SBCertificateAutoGenerationKey `
    -MessageContainerDBConnectionString 'Data Source=WingtipServer;Initial Catalog=WF_ServiceBus_MessageContainer;Integrated Security=True;Encrypt=False' | Out-Null
...
New-WFFarm `
    -WFFarmDBConnectionString 'Data Source=WingtipServer;Initial Catalog=WF_ManagementDB;Integrated Security=True;Encrypt=False' `
    -RunAsAccount 'WINGTIP\SP_Workflow' `
    -AdminGroup 'BUILTIN\Administrators' `
    -HttpsPort 12290 `
    -HttpPort 12291 `
    -InstanceDBConnectionString 'Data Source=WingtipServer;Initial Catalog=WF_InstanceManagementDB;Integrated Security=True;Encrypt=False' `
    -ResourceDBConnectionString 'Data Source=WingtipServer;Initial Catalog=WF_ResourceManagementDB;Integrated Security=True;Encrypt=False' `
